            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 20 }}>
              {bestDay && (
                <div style={{ background: "var(--card)", border: "1px solid var(--border)", borderRadius: 12, padding: "16px 18px" }}>
                  ...
                  <div style={{ fontFamily: "var(--font-fraunces)", fontSize: 22, color: "var(--g)", fontWeight: 700 }}>+{bestDay.pnl.toFixed(0)}{sym(currency)}</div>
              ...
              {worstDay && worstDay.pnl < 0 && (
                <div style={{ background: "var(--card)", border: "1px solid var(--border)", borderRadius: 12, padding: "16px 18px" }}>
                  ...
                  <div style={{ fontFamily: "var(--font-fraunces)", fontSize: 22, color: "var(--r)", fontWeight: 700 }}>{worstDay.pnl.toFixed(0)}{sym(currency)}</div>
