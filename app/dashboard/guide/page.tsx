...
const sections = [
  ...
  },
  {
    ...
    steps: [
      { label: "Signal prédictif du jour", desc: "Alpha prédit ta performance probable du jour avant même que tu ouvres un chart, basé sur ton historique réel." },
      { label: "Profil trader & insights personnalisés", desc: "Ton win rate, P&L moyen, profit factor et score mental calculés sur tout ton historique. Des insights textuels détectent automatiquement tes points forts et faiblesses." },
      { label: "Corrélation état mental → performance", desc: "Vois comment ton score mental impacte directement tes résultats. La relation entre psychologie et performance visualisée sur toutes tes sessions." },
      { label: "Impact discipline & émotions en chiffres", desc: "Compare tes trades disciplinés vs non-disciplinés, et vois exactement combien chaque émotion (FOMO, Calme, Confiant…) te rapporte ou te coûte en moyenne." },
      { label: "Performance par paire", desc: "Quelles paires sont réellement rentables pour toi ? Alpha analyse ton win rate et P&L moyen sur chaque instrument que tu trades." },
      { label: "Performance par jour & évolution du score mental", desc: "Tes lundis sont-ils rentables ? Tes vendredis catastrophiques ? Et comment ton score mental évolue-t-il dans le temps ?" },
    ],
