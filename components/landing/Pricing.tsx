...
const planFeatures = {
  monthly: [
    "Sais si tu dois trader avant d'ouvrir les charts",
    "Score mental + signal de session en moins de 10 min",
    "Log de trades avec contexte émotionnel intégré",
    "Rapport hebdo — tes patterns, pas tes suppositions",
    "Journal post-session pour ne pas répéter les mêmes erreurs",
    "Stop quand tu veux — sans friction",
  ],
  annual: [
    "Toutes les fonctionnalités · 2 mois offerts",
    "178€ économisés vs le mensuel sur l'année",
    "Nouvelles features en avant-première",
    "Support prioritaire — réponse sous 48h",
    "Le choix du trader qui s'engage dans sa progression",
  ],
  lifetime: [
    "Un paiement. C'est tout. Pour toujours.",
    "★ Alpha — ton profil psychologique de trader en chiffres",
    "Toutes les futures features incluses, à vie",
    "Support direct — tu passes avant tout le monde",
    "Prix bloqué · Aucune hausse possible, jamais",
    "Amorti dès le 1er trade émotionnel évité",
  ],
};
